...
export const CreateSurprisePage: React.FC = () => {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        if (['image', 'video', 'audio', 'link'].includes(formData.type_media)) {
            try {
    ...
    return (
        <div className="max-w-4xl mx-auto space-y-2">
            ...
            <div>
                ...
                <img src={"/img/surprise_form.png"} className={"h-52 m-auto rounded-2xl shadow"}/>
